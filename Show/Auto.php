        ...
        <div class="container">
            ...
            <!--         <span style="color:#fff";>Selamat Datang, <?php echo $sesi['username'];?></span> -->
                    ...
                    <div class="card">
                                ...
                                <tbody>
                                  ...
                                  // echo "$con";
                                    for ($a=0; $a < $coun ; $a++) { 
                                        ...
                                        echo "<td>".$key->sensor_value[$a]." <b> ".$key->satuan[$a]." <b> </td>";
                        ...
                        for ($i=0; $i < count($key->sensor_pin); $i++) { 
                            $stripped = str_replace(' ', '', $key->desc_sensor[$i]);
                            $variable = $variable ."String(".$stripped.") ";   
                            if($i != count($key->sensor_pin) -1){
                                $variable = $variable.'+ comma+';
                            }
                        }
                        echo 'String str = "{\"id\":\"112:20:45062021\",\"sensor_value\":";<br>';
                        echo 'String comma = ",";<br>';
                        echo $variable.";<br>";
                        echo 'String str3 = "]\}";<br>';
                        echo 'String str4 = str +str2 +str3;<br>';
                        echo 'int httpResponseCode = http.POST(str4);<br>';
                         ?>
                            ...
                            <table class="table table-hover table-bordered" id="mytable" style="margin-top: 10px">
                                <thead>
                                    <tr>
                                        ...
                                        <?php 
                                        for ($i=0; $i < $coun ; $i++) { 
                                            echo "<th>".$key->desc_sensor[$i]."  ( <b>".$key->satuan[$i]." <b> )</th>";
